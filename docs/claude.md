...
| `reference/news_sources.md` | 브리핑 소스 선정 | 크롤링/큐레이션 소스 목록(14분류·RSS). **소스 단일 출처.** 유럽(EU)·중국(CN) 섹션 포함 | 08-06 |
| `howto/routine_instruction.md` | 루틴 이해·수정 | 브리핑 자동생성 절차(WebSearch 전용). 발행 중복 대조 관문 · 카드 스키마 · 별점 루브릭 · §3 확장 소스 목록 · §10 발행 게이트 | 08-06 |
