...
> 최초 정리: 2026-07-06 · 최종 갱신: **2026-08-19**(뉴스핌·매거진한경 조건부 등록 · 한경 계열 명시) · 관리 방식: 새 소스 추가/삭제 시 이 파일만 갱신.
...
- **매체 분산.** 섹션당 동일 매체 1건 권장(최대 2). **계열 매체는 같은 소스로 센다.**
  · 디자인플러스 · 헤이팝(heyPOP) · 행복이 가득한 집 = **디자인하우스** 계열
  · 한국경제 · 매거진한경(한경BUSINESS·MONEY·ESG) = **한국경제** 계열 (2026-08-19 추가)
  · Korea Herald · 헤럴드경제 = **헤럴드** 계열
...
| EBN 산업경제 | KR | https://www.ebn.co.kr/ | 자동 | ○ | 산업·경제 매체. BI·브랜드 리뉴얼 단독 보도가 나온다. ⚠️ 디자인 전문 매체가 아님 — **자체 취재·단독 기사만 사용**하고 기업 홍보성 기사는 카드로 쓰지 않는다 |
| 더쎈뉴스(The CEN News) | KR | https://www.mhns.co.kr/ | 자동 | ○ | 문화예술·K컬처 종합 미디어(구 문화뉴스). 기자 실명 서명, `[단독]` 자체 취재 이력 있음. ⚠️ 디자인 전문 매체가 아니고 **전시·공연 홍보성 기사가 많다** — 자체 취재·단독 보도만 쓰고 팬덤 이벤트·연예 홍보 기사는 카드로 쓰지 않는다 |
| 일간스포츠 | KR | https://isplus.com/ | 자동 | ○ | 스포츠·레저·연예 전문 일간지(1969년 창간, 現 KG그룹). 기자 실명 서명·언론노조 소속. ⚠️ 디자인·AI 전문 매체가 아니다 — **AI·콘텐츠 산업 분석 기사만** 쓰고 연예인 동정·공연 홍보 기사는 카드로 쓰지 않는다 |
| 뉴스핌 | KR | https://www.newspim.com/ | 자동 | ○ | 종합 뉴스통신사(2003년 온라인 경제신문 창간, 2018년 통신사 전환). 로이터·블룸버그 제휴, 11개 취재부서. ⚠️ 디자인 전문 매체가 아니고 **행사·기업 홍보성 기사가 섞인다** — 자체 취재분만 쓴다 |
| 매거진한경 | KR | https://magazine.hankyung.com/ | 자동 | ○ | 한국경제매거진(한경BUSINESS·MONEY·ESG). **한국경제 계열로 합산한다.** ⚠️ 경제·경영 매거진이라 디자인 전문이 아니다 — **브랜드·디자인 분석 기사만** 쓴다 |
...
| 베타뉴스 | KR | https://www.betanews.net/ | 자동 | ○ | IT·게임 전문 인터넷 언론사(2002년 창간, 한국인터넷신문협회 회원사). ⚠️ 디자인 전문 매체가 아니고 신제품·협업 기사에 보도자료 전재가 섞임 — **자체 취재·리뷰만 사용** |
| 디지털투데이 | KR | https://www.digitaltoday.co.kr/ | 자동 | ○ | 디지털 경제 미디어(2007년 창간, 구 아이티투데이·키뉴스). ICT·AI·핀테크·모빌리티 심층보도. 기자 실명 서명 |
...
| 링커리어 | KR | https://linkareer.com/ | 자동 | △ | 대학생·취준생 커리어 플랫폼. ⚠️ 언론사가 아니고 **콘텐츠 상당수를 대학생 에디터가 제작**한다. 잡코리아보다 신뢰도가 낮으므로 **현직자 인터뷰·포트폴리오 실무 콘텐츠만** 쓰고, 대외활동·공모전 모집 글은 카드로 쓰지 않는다 |
...
- **2026-08-12 갱신**: 8/12 브리핑에서 `베타뉴스`·`EBN` 2건이 게이트 [1] UNKNOWN으로 걸렸다. 둘 다 4항목 중 **④(분야 전문성)만 미달**이라 잡코리아와 같은 **조건부 등록**으로 처리했다. `EBN`은 해당 카드가 `[단독]` KFC BI 리뉴얼이고 인터넷신문협회 기자상을 2회(2026-03·2026-06 보도분) 받은 자체 기획취재 이력이 있어 ①②③ 통과. `베타뉴스`는 2002년 창간 IT·게임 전문 인터넷 언론사·협회 회원사로 ①③ 통과이나, 해당 카드(컴포즈커피 협업 굿즈)가 보도자료 성격이라 ②를 조건으로 제한했다. 배치는 `EBN`→§12(디자인·산업·문화), `베타뉴스`→§13(AI·IT·테크). 루틴 §3에도 같은 변경에서 반영했다.
- **2026-08-13 갱신**: 8/13 브리핑에서 `source_rules.json` 미등록 4건이 걸렸다. **이번엔 배포 검증 단계에서 8매체 전수 대조를 먼저 해 게이트 [1]을 1회에 통과했다**(8/12는 국내 매체만 훑어 `Adobe Blog`를 놓치고 2회 실행했다). 4건 중 `Nielsen Norman Group`(§4)·`캐릿`(§14)은 **이 파일에 이미 있었고** `source_rules.json` 에만 없었다 — `VentureBeat` 와 같은 표기·동기화 격차다. 신규는 2건 — `디지털투데이`는 2007년 창간 ICT 전문 매체로 4항목 전부 통과해 §13에 무조건부 등록, `링커리어`는 언론사가 아니고 콘텐츠를 대학생 에디터가 제작해 ④ 미달이라 §14에 조건부 등록했다. 루틴 §3에도 같은 변경에서 반영했다.
- **2026-08-16 갱신**: 8/16 브리핑에서 미등록 4건(`Google`·`더쎈뉴스`·`NN/g`·`Smashing Magazine`)이 걸렸으나 **이 파일에 추가한 것은 `더쎈뉴스` 1건뿐**이다. `NN/g`(§4 `Nielsen Norman Group`)·`Smashing Magazine`(§4)은 이미 등재돼 있었고 `source_rules.json` 에만 없던 표기 격차였다. `Google`은 공식 블로그(1차 소스)라 이 파일 대상이 아니다. **`NN/g` 는 `source_rules.json` 에 `group=Nielsen Norman Group` 별칭으로 넣어 매체 상한 계산이 풀네임과 합산되게 했다** — 루틴이 약어와 풀네임을 번갈아 쓰므로 별칭 등록이 근본 해결이다. `더쎈뉴스`는 4항목 중 ④(디자인 전문성) 미달·②(보도자료 전재) 불안이라 조건부로 §12에 넣었다. 8/16 카드가 팬덤 전시 홍보성이었으므로 재등장 시 재검토한다.
- **2026-08-18 갱신**: 8/18 브리핑에서 미등록 3건(`Google DeepMind`·`Spoon & Tamago`·`일간스포츠`) 중 **이 파일에 추가한 것은 `일간스포츠` 1건뿐**이다. `Google DeepMind`(§2 `Google DeepMind Blog`)·`Spoon & Tamago`(§11, 표기까지 동일)는 이미 등재돼 있었다. `일간스포츠`는 4항목 중 ④(분야 전문성)만 미달이라 조건부로 §12에 넣었다 — ①기자 실명 서명·언론노조 소속 ②해당 카드는 연예 홍보가 아니라 AI 영상 산업 분석 ③1969년 창간 종합 일간지의 자체 취재 체계 ④스포츠·연예 전문. **루틴 §3 에는 AI 국내 축에 넣었다** — 이 파일은 매체의 정체성으로, 루틴 §3 은 무엇을 크롤링하고 싶은지로 나눈다(2026-08-11 PetaPixel 선례).
- **2026-08-19 갱신**: 8/19 브리핑에서 미등록 2건(`뉴스핌`·`매거진한경`)이 걸렸고 **최근 4일 중 처음으로 전부 신규**였다(8/16~8/18 은 대부분 표기 격차였다). 둘 다 4항목 중 ④(분야 전문성)만 미달이라 조건부로 §12에 등록했다 — `뉴스핌`은 로이터·블룸버그 제휴 통신사이나 해당 카드가 29CM DDP디자인페어 개최 기사라 ② 홍보성 우려가 있어 자체 취재분만 쓰기로 했고, `매거진한경`은 국보디자인 BI 리뉴얼 분석이라 ②는 통과했다. **`매거진한경`은 한국경제 계열이므로 `source_rules.json` 에 `group=한국경제` 로 넣었고, 이 파일 「선별·매체 분산 원칙」에 한경 계열을 명시했다** — ③ 4번 규칙상 계열 합산은 이 문서에 적힌 것만 적용하므로 근거를 함께 남겨야 한다. 헤럴드 계열도 같은 이유로 병기했다.
